...
func Metrics(hostToken string, taskMsg task.Message) error {
	...
	metricList := []mList{
		...
		{metricId: metric.RamCache, taskPropertyId: taskMsg.RamCache},
		{metricId: metric.RamBuffers, taskPropertyId: taskMsg.RamBuffers},
		{metricId: metric.RamAvailable, taskPropertyId: taskMsg.RamAvailable},
